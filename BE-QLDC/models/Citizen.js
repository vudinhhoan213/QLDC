...
const citizenSchema = new Schema(
  {
    ...
    maritalStatus: { type: String, enum: ['SINGLE', 'MARRIED', 'DIVORCED', 'WIDOWED', 'UNKNOWN'], default: 'UNKNOWN' },

    phone: { type: String, trim: true },
    email: { type: String, trim: true, lowercase: true },
    avatarUrl: { type: String },

    status: { type: String, enum: ['ALIVE', 'DECEASED', 'MOVED_OUT'], default: 'ALIVE', index: true },
    deathDate: { type: Date },
